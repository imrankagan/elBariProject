...
dayanıklılığı yoktur**. Oran yarışında ElBâri konum verisinde önde, sürekli telemetride
%2-7 geride, tekrarlı kanallarda belirgin geride
([kıyas raporu](KIYAS_TAMSAYI_KODEKLER.md)). Yani projenin savunulabilir katkısı oran
değil, **kayıplı linkte çalışabilmek**.
...
| --- | ---: | ---: | ---: | ---: |
| Yönelim (ATT) | 55.795 B | 14,70x | 224 | **%10,5** |
| GPS | 59.695 B | 4,95x | 239 | **%9,1** |

Tek bir paket düşerse akışın tamamı çözülemez. **%1 kayıpta akışın onda dokuzu
tamamen gider.** Nominal 14,70x'lik oran, etkin olarak **1,5x**'e iner.
...
| 100 | 77.869 | 10,53x | 1,02 | 10,42x | 9,94x | 9,51x | 7,86x |
| 200 | 61.902 | 13,25x | 1,28 | 13,10x | 12,43x | 11,54x | **9,05x** |
| 500 | 53.181 | 15,42x | 1,95 | 15,11x | **14,14x** | **12,65x** | 8,65x |
| 1000 | 49.325 | 16,63x | 3,33 | **16,09x** | 14,03x | 11,48x | 6,06x |
...
| ---: | ---: | ---: | ---: |
| 200 | 9,05x | 9,77x | **10,09x** |
| 500 | 8,65x | 10,21x | **11,40x** |
| 1000 | 6,06x | 9,75x | **10,62x** |
...
%1 kayıpta ATT için 500 → 15,11x, 1000 → 16,09x; GPS için 500 → 4,54x, 1000 → 4,61x.
